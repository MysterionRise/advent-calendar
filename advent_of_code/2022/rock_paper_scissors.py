...
first column is what your opponent is going to play: A for Rock,
...
will choose Paper (B), and you should choose Rock (X). This ends in a loss
for you with a score of 1 (1 + 0). The third round is a draw with both
players choosing Scissors, giving you a score of 3 + 3 = 6. In this example,
if you were to follow the strategy guide, you would get a total score of 15
(8 + 1 + 6).
...
the second cpolumn says how the round needs to end: X means you need to
...
of 1 + 3 = 4. In the second round, your opponent will choose Paper (B),
and you choose Rock so you lose (X) with a score of 1 + 0 = 1. In the third
...
def main():
    ...
    """
    with open("rock_paper_scissors.txt", encoding="utf-8") as file:
