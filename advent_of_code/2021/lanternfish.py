...
After one day, its internal timer would become 2. After another day,
its internal timer would become 1. After another day, its internal timer
would become 0. After another day, its internal timer would reset to 6,
and it would create a new lanternfish with an internal timer of 8. After
another day, the first lanternfish would have an internal timer of 5,
and the second lanternfish would have an internal timer of 7. A lanternfish
that creates a new fish resets its timer to 6, not 7 (because 0 is included
as a valid timer value). The new lanternfish starts with an internal timer
...
def main():
    ...
    with open("lanternfish.txt", encoding="utf-8") as file:
        ...
        for _ in range(256):
            ...
            for age in range(8, -1, -1):
                if age != 0:
                    ...
                    new_fishes[6] = new_fishes.get(6, 0) + fishes[age]
                    new_fishes[8] = new_fishes.get(8, 0) + fishes[age]
            fishes = new_fishes
        print(fishes)
